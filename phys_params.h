...
//	 vector<uint32_t>  base_mi; // added ptr to starting output base per Block in Blk design
	...
	string i;  // added variable to store source bits file name
	string q;  // added variable to store seed file name
	string of; // added variable to store output data file name
